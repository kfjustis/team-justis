...
-- @param  Integer
-- @output Bool
-- @description: Searched how to determine if a year is a leap year to figure out what the calculation had to be, got the calculation from https://support.microsoft.com/en-us/help/214019/method-to-determine-whether-a-year-is-a-leap-year. Used the mod function to check for the two cases that would indicate a leap yaer, else not a leap year.
prob5 :: Integer -> Bool
prob5 x
